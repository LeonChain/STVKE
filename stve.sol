...
contract STVE is ERC20Interface {

    using SafeMath for uint256;

    string public constant symbol = "FINITE";
    string public constant name = "STVE";
    uint8 public constant decimals = 18;
    uint256 _totalSupply = 1000000;
    STVPOCKET[] public ChronologicalBalances;
    ...
    function totalSupply() override public virtual view returns (uint256 totalSupply) {
    ...
    function transfer(address _to, uint256 _amount) override public returns (bool success) {
        if (balances[msg.sender] >= _amount 
            ...
            */
            ...
            /*
            * add ChronologicalBalances to the recepient's POCKET
            */
            
            /*
            * handle liquidity pool and staking pool
            */
